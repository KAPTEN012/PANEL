...
<!----><!----><!----><!----><!----><!----><!----><!----><!----><!---->
     ...
     <div class="col-lg-6">
        <div class="card mb-3">
            <div class="card-header text-white"style="background: url('https://wallpapercave.com/uwp/uwp4544754.jpeg');">𝑺𝒆𝒓𝒗𝒆𝒓 𝑩𝒂𝒔𝒆𝒅 𝑴𝒐𝒅</div>
            <div class="card-body">
                <?= form_open() ?>
    ...
    <div class="col-lg-6">
        <div class="card mb-3">
             <div class="card-header text-white"style="background: url('https://wallpapercave.com/uwp/uwp4544754.jpeg');">
                𝐌𝐨𝐝 𝐅𝐞𝐚𝐭𝐮𝐫𝐞
            </div>
                <div class="card-body">
                    <?= form_open() ?>
    ...
    <div class="col-lg-6">
        <div class="card mb-3">
 <div class="card-header text-white"style="background: url('https://wallpapercave.com/uwp/uwp4544754.jpeg');">𝑪𝒉𝒂𝒏𝒈𝒆 𝑴𝒐𝒅 𝑵𝒂𝒎𝒆</div>
            <div class="card-body">
                <?= form_open() ?>
    ...
    <div class="col-lg-6">
        <div class="card mb-3">
         <div class="card-header text-white"style="background: url('https://wallpapercave.com/uwp/uwp4544754.jpeg');">𝑪𝒉𝒂𝒏𝒈𝒆 𝑭𝒍𝒐𝒂𝒕𝒊𝒏𝒈 𝑻𝒆𝒙𝒕</div>
            <div class="card-body">
                <?= form_open() ?>
