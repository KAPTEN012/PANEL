...
<div class="row">
    ...
    <div class="col-lg-8" style="padding:15px;">
        <div class="card mb-3">
           <div class="card-header text-center text-white"style="background: url('https://c.wallhere.com/photos/36/5d/anime_anime_girls_Honkai_Star_Rail_Kafka_Honkai_Star_Rail_purple_hair_purple_eyes_looking_at_viewer_gloves-2274356.jpg!s1');">
                𝐄𝐱𝐩𝐢𝐫𝐚𝐭𝐢𝐨𝐧
              </div>
              <div class="card-body">
                  <p id="exp"></p>
    ...
    <div class="col-lg-8" style="padding:15px;">
        <div class="card mb-3">
             <div class="card mb-3">
             <div class="card-header text-center text-white"style="background: url('https://wallpapercave.com/uwp/uwp4544754.jpeg');">
                𝐃𝐞𝐭𝐚𝐢𝐥𝐬
              </div>
              <div class="card-body">
